...
public class BNBSounds {
	public static final BlockSounds NYLIUM_BLOCK = new BNBBlockSound("nylium", 1.0F, 1.0F);
	public static final BlockSounds MOSS_BLOCK = new BNBBlockSound("moss", 1.0F, 1.0F);
